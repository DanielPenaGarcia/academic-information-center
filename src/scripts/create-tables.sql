...
CREATE TABLE IF NOT EXISTS `classes` (
    ...
    `created_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP
    `updated_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMPWAS
);
...
CREATE TABLE IF NOT EXISTS `enrrollmentPeriod` (
    `id` INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS `enrollmentAppoinment` (
    `id` INT AUTO_INCREMENT PRIMARY KEY,
    `student_id` INT NOT NULL,
